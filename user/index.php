...
<body class="fix-header fix-sidebar card-no-border">
                    ...
                    <div class="col-sm-12">
                            <div class="card-block">
                                <?php
                                  ...
                                  $result = mysqli_fetch_array($query);
                                ?>
                                <p  style="font-weight: bolder; color: blue; font-size: 50px; text-align: -webkit-center; font-family: initial; padding-bottom: 10px;"> Selamat Datang <?php echo $result['NAMA_DEPAN'] ?> <?php echo $result['NAMA_BELAKANG'] ?></p>                              
                            </div>
                    </div>
                </div>
            </div>
    ...
    <?php
    if (isset($_SESSION['status_login']) && ($_SESSION['status_login'] === 'sukses')){
