                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-user"></i> Tambah Soal
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                <form role="form" enctype="multipart/form-data" method="POST" id="uploadForm" action="proses.php">
                        ...
                        <label>Peminatan</label>
                            ...
                            <div class="form-group">
                                <label>Soal</label>
                                <textarea name="soal" class="tinymce" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="jawaban1" class="form-control" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Jawaban 2</label>
                                <textarea name="jawaban2" class="form-control" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Jawaban 3</label>
                                <textarea name="jawaban3" class="form-control" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Jawaban Benar</label>
                                <textarea name="jawabanBenar" class="form-control" rows="2"></textarea>
                            </div>
