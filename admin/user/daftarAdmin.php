                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-menu-hamburger"></i> Daftar Admin
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            while($row = mysqli_fetch_array($result))  {  
                                echo    '<tr>  
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                <a class="btn btn-danger" href="proses.php?aksi=hapusUser&ID_ADMIN='. $row['ID_ADMIN'] .'" onClick="alert_show()">Hapus</a></td>
                                                </div>  
                                        </tr>';  
                                  }  
                                  ?>
