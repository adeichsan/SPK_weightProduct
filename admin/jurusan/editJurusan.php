    ...
    <div id="wrapper">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="jurusan" class="collapse">
                            <li>
                                <a href="tambahJurusan.php"><i class="glyphicon glyphicon-plus"></i> Tambah </a>
                            </li>
                            <li>
                                <a href="daftarJurusan.php" class="glyphicon glyphicon-list"> Daftar </a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="glyphicon glyphicon-menu-hamburger"></i> Prodi
                            </li>
                            <li class="active">
                                <i class="glyphicon glyphicon-file"></i> Edit Prodi
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                $result = mysqli_fetch_array($query);   
                ?>
                <form role="form" method="POST" action="proses.php?ID_PRODI=<?php echo $result['ID_PRODI'] ?>">
                            <div class="form-group">
                                <label>Nama Prodi</label>
                                <input name="prodi" class="form-control" value="<?php echo $result['NAMA_PRODI'] ?>">
                            </div>
                            <div class="form-group">
                                <label>kode Prodi</label>
                                <input name="kode" class="form-control" value="<?php echo $result['KODE_PRODI'] ?>">
                            </div>
                            <button name="editProdi" styssle="float: right" class="btn btn-primary">Update</button>
                        </form>
