                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active>
                                <i class="glyphicon glyphicon-menu-hamburger"></i> Daftar Prodi
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <?php  
                                    ...
                                    echo    '<tr>  
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                <a class="btn btn-default" href="editJurusan.php?ID_PRODI='. $row['ID_PRODI'] .'">Edit</a>
                                                <a class="btn btn-danger" href="proses.php?aksi=hapusProdi&ID_PRODI='. $row['ID_PRODI'] .'" onClick="return confirm("Apakah Ada yakin menghapus ?")">Hapus</a></td>
                                                </div>  
                                        </tr>';  
                                  }  
                                  ?>
