            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-user"></i> Tambah Prodi
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form role="form" method="POST" action="proses.php">
                    <div class="form-group">
                        <label>Prodi</label>
                        <input name="prodi" class="form-control" placeholder="Masukkan Prodi" required="">
                    </div>
                    <div class="form-group">
                        <label>Kode Prodi</label>
                        <input name="kodeProdi" maxlength="3" required="" onkeypress="return angka(event)" class="form-control" placeholder="Masukkan Kode Prodi">
                    </div>
