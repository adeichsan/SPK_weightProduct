...
<head>
    ...
    <!-- Bootstrap Javascript datatables -->
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-menu-hamburger"></i> Daftar Mata Kuliah
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <?php
                            include '../../connect.php';
                            $query = "SELECT SKS, ID_KRITERIA, STATUS, KRITERIA, BOBOT, ALTERNATIF, NAMA_PRODI FROM kriteria INNER JOIN alternatif ON kriteria.ID_ALTERNATIF = alternatif.ID_ALTERNATIF INNER JOIN prodi ON prodi.ID_PRODI = alternatif.ID_PRODI";
                            ...
                            while($row = mysqli_fetch_array($result))  {  
                                echo    '<tr>    
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                <a class="btn btn-default" href="editKriteria.php?ID_KRITERIA='. $row['ID_KRITERIA'] .'">Edit</a>
                                                <a class="btn btn-danger" href="proses.php?aksi=hapusKriteria&ID_KRITERIA='. $row['ID_KRITERIA'] .'" onClick="return confirm("Apakah Ada yakin menghapus?")">Hapus</a></td>
                                                </div>  
                                        </tr>';  
                                  }  
                                  ?>
    ...
    if (isset($_SESSION['update']) && ($_SESSION['update'] === 'berhasil')){
        ...
        echo "<script> alert_show('Deelete Data', 'Berhasil !!!') </script>";
